...
contract ERC20Test is DSTestPlus {
    ...
    function testMint() public {
        mockToken.mint(address(0xBEEF), 1e18);
    ...
    function testBurn() public {
        mockToken.mint(address(0xBEEF), 1e18);
        mockToken.burn(address(0xBEEF), 0.9e18);
    ...
    function testTransfer() public {
        mockToken.mint(address(this), 1e18);
    ...
    function testFailTransferInsufficientBalance() public {
        mockToken.mint(address(this), 0.9e18);
    ...
    function testMetadata(
        ...
        MockERC20 mockTkn = new MockERC20(name, symbol, decimals);
        ERC20 tkn = ERC20(address(mockTkn));
    ...
    function testBurn(
        ...
        mockToken.mint(from, mintAmount);
        mockToken.burn(from, burnAmount);
    ...
    function testFailBurnInsufficientBalance(
        ...
        mockToken.mint(to, mintAmount);
        mockToken.burn(to, burnAmount);
    }
    ...
    function testFailTransferInsufficientBalance(
        ...
        mockToken.mint(address(this), mintAmount);
...
contract ERC20Invariants is DSTestPlus, DSInvariantTest {
    ...
    function setUp() public {
        mockToken = new MockERC20("Token", "TKN", 18);
        token = ERC20(address(mockToken));
        balanceSum = new BalanceSum(mockToken);
